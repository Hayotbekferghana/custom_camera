...
// ignore_for_file: parameter_assignments, comment_references
...
class CameraValue {
  ...
  @override
  String toString() => '${objectRuntimeType(this, 'CameraValue')}('
...
class CameraController extends ValueNotifier<CameraValue> {
  ...
  Widget buildPreview() => CameraPlatform.instance.buildPreview(_cameraId);
...
class Optional<T> extends IterableBase<T> {
  ...
  Optional<S> transform<S>(S Function(T value) transformer) => _value == null
        ? Optional<S>.absent()
  ...
  Optional<S> transformNullable<S>(S? Function(T value) transformer) => _value == null
        ? Optional<S>.absent()
