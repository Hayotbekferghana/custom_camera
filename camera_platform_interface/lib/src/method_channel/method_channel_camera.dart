...
// ignore_for_file: cascade_invocations, deprecated_member_use_from_same_package, prefer_asserts_with_message
...
class MethodChannelCamera extends CameraPlatform {
  ...
  Future<void> startVideoRecording(int cameraId,
      {Duration? maxVideoDuration}) async => startVideoCapturing(
